...
@Component({
  selector: 'app-graphics-condominium',
  templateUrl: './graphics-condominium.component.html',
  styleUrls: ['./graphics-condominium.component.scss']
})
export class GraphicsCondominiumComponent implements OnInit {
